...
// Usa a Ordem Topologica -> Algorithms Illuminated Part02
// Precisa ser um grafo DIRETO e ACICLICO.
// Se tiver ciclos -> Não tem como ter ordem

// Como lidar com 02 nós sendo root? R: Kahn's Algorithm
 ...
 *
 * Usa o algoritmo de Kahm para descobrir a ordem topologica e numero de nós visitados.
 * Se o numero de nós visitados for maior do que o tamanho de nós, então teve ciclos.
 *
 */
public class CourseSchedule {
    ...
    public boolean canFinish(int numCourses, int[][] prerequisites) {
        ...
        // used if want to know one topological order
